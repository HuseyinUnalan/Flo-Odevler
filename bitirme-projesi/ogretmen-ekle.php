      ...
      if (@$_GET['durum'] == "ok") { ?>
        ...
        <div class="col-12 col-lg-12">
          <div class="alert alert-success alert-dismissible" role="alert">
            <a href="ogretmen-ekle"><button type="button" class="close">&times;</button></a>
            <div class="alert-icon contrast-alert">
              <i class="fa fa-check"></i>
            </div>
            <div class="alert-message">
              <span><strong>Başarılı!</strong> Öğretmen Başarılı Bir Şekilde Kayıt Edildi</span>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-primary top-icon nav-justified">
              <li class="nav-item">
                <a href="javascript:void();" data-target="#tab1" data-toggle="pill" class="nav-link active"><i class="icon-note"></i> <span class="hidden-xs">Öğretmen Kayıt Formu</span></a>
              </li>
              ...
              <div class="tab-pane active" id="tab1">
                ...
                <form action="netting/islem.php" enctype="multipart/form-data" method="POST">
                  ...
                  <div class="form-group row">
                    <label class="col-lg-3 col-form-label form-control-label" for="first-name">Öğretmen Fotoğraf Seç
                    </label>
                    <div class="col-lg-9">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                      <input class="form-control" name="ogretmen_adsoyad" type="text" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                      <input class="form-control" name="ogretmen_tc" type="text" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                      <input class="form-control" name="ogretmen_tel" type="text" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                      <select name="ogretmen_brans" class="form-control" required>
                        <?php
                  ...
                  <button class="btn btn-success" name="ogretmenkaydet" style="float: right;"><i class="fa fa-check-square-o"></i> Kaydet</button>
