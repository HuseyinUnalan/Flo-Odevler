              ...
              <div class="tab-pane active" id="tab1">
                ...
                <form action="netting/islem.php" method="POST" data-parsley-validate enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                      <input class="form-control" name="not_vize1" value="<?php echo $notcek["not_vize1"] ?>" type="text">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                      <input class="form-control" name="not_vize2" value="<?php echo $notcek["not_vize2"] ?>" type="text">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                      <input class="form-control" name="not_final" value="<?php echo $notcek["not_final"] ?>" type="text">
                    </div>
                  </div>
                  ...
                  <button class="btn btn-success" name="notduzenle" style="float: right;"><i aria-hidden="true" class="fa fa-edit"></i> Kaydet</button>
