...
$mesajsor = $db->prepare("SELECT * FROM mesaj, kullanici, ogretmen where mesaj.kullanici_gon=kullanici.kullanici_mail and mesaj.kullanici_gel=ogretmen.ogretmen_id  ORDER BY mesaj_zaman DESC");
$mesajsor->execute();
    ...
    <tbody>
      ...
      ?>
          <tr>
            ...
            <td><?php echo $mesajcek["ogretmen_adsoyad"] ?></td>
